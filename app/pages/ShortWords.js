...
const ShortWords = (props) => {
    ...
    <Row style={{backgroundColor: "#f3f3f3", margin:0}}>
        <Col md={2}></Col>
        <Col md={6} className="short-words-body bg-white">
            <Media className="short-words-body-media">
                <Media.Body className="short-words-media-body short-words-body-media-body">
                        <div className="row">
                        <div className="short-words-body-media-date col">'19 Tem</div>
                        <div className="short-words-body-media-user text-right col">
                            <Image className="short-words-body-media-user-img" src="https://cdn.pixabay.com/photo/2019/10/19/13/00/autumn-forest-4561344_1280.jpg" roundedCircle />
                            username</div>
                        </div>
                    <div className="short-words-media-body-title text-center">
                    "Media Heading Media Heading Media Heading Media Heading Media"
                    </div>
                    <div className="short-words-media-body-buttons justify-content-center row">
                                <Button variant="link" className="visitButton" size="md"><FaEye /><span className="short-words-media-body-button">22</span></Button>
                                <Button variant="link" className="likeButton" size="md"><FaRegThumbsUp /><span className="short-words-media-body-button">22</span></Button>
